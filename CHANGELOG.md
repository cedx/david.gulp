...
## Version [13.2.0](https://github.com/cedx/gulp-david/compare/v13.1.0...v13.2.0)
...
## Version [8.0.0](https://github.com/cedx/gulp-david/compare/v7.0.1...v8.0.0)
- Breaking change: restored the [Observable](http://reactivex.io/intro.html) APIs.
- Updated the package dependencies.

## Version [7.0.1](https://github.com/cedx/gulp-david/compare/v7.0.0...v7.0.1)
...
## Version [6.2.0](https://github.com/cedx/gulp-david/compare/v6.1.0...v6.2.0)
- Updated the package dependencies.

## Version [6.1.0](https://github.com/cedx/gulp-david/compare/v6.0.0...v6.1.0)
- Updated the package dependencies.
...
## Version [4.1.0](https://github.com/cedx/gulp-david/compare/v4.0.0...v4.1.0)
...
## Version [4.0.0](https://github.com/cedx/gulp-david/compare/v3.1.0...v4.0.0)
- Breaking change: dropped the dependency on [Observables](http://reactivex.io/intro.html).
- Updated the package dependencies.

## Version [3.1.0](https://github.com/cedx/gulp-david/compare/v3.0.2...v3.1.0)
- Replaced the [Codacy](https://www.codacy.com) code coverage service by the [Coveralls](https://coveralls.io) one.
- Updated the package dependencies.

## Version [3.0.2](https://github.com/cedx/gulp-david/compare/v3.0.1...v3.0.2)
- Fixed the [issue #11](https://github.com/cedx/gulp-david/issues/11).

## Version [3.0.1](https://github.com/cedx/gulp-david/compare/v3.0.0...v3.0.1)
- Updated the package dependencies.
...
## Version [2.0.3](https://github.com/cedx/gulp-david/compare/v2.0.2...v2.0.3)
...
## Version [2.0.2](https://github.com/cedx/gulp-david/compare/v2.0.1...v2.0.2)
- Updated the [David](https://david-dm.org) dependency to its latest version.

## Version [2.0.1](https://github.com/cedx/gulp-david/compare/v2.0.0...v2.0.1)
- Raised the required [Node.js](https://nodejs.org) version to reflect the latest breaking changes.

## Version [2.0.0](https://github.com/cedx/gulp-david/compare/v1.0.0...v2.0.0)
...
## Version [0.3.4](https://github.com/cedx/gulp-david/compare/v0.3.3...v0.3.4)
...
## Version [0.3.1](https://github.com/cedx/gulp-david/compare/v0.3.0...v0.3.1)
- Added support for [SonarQube](http://www.sonarqube.org) code analyzer.
- Updated the sample `gulpfile.js`.

## Version [0.3.0](https://github.com/cedx/gulp-david/compare/v0.2.3...v0.3.0)
...
## Version [0.2.3](https://github.com/cedx/gulp-david/compare/v0.2.2...v0.2.3)
- Updated the package dependencies.

## Version [0.2.2](https://github.com/cedx/gulp-david/compare/v0.2.1...v0.2.2)
- Updated the package dependencies.

## Version [0.2.1](https://github.com/cedx/gulp-david/compare/v0.2.0...v0.2.1)
- Updated the package dependencies.

## Version [0.2.0](https://github.com/cedx/gulp-david/compare/v0.1.1...v0.2.0)
- Breaking change: raised the required [Node.js](http://nodejs.org) version.
- Breaking change: removed the dependency on [`promise`](https://www.npmjs.com/package/promise) module.
- Updated the package dependencies.

## Version [0.1.1](https://github.com/cedx/gulp-david/compare/v0.1.0...v0.1.1)
