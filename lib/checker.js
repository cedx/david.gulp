...
module.exports = class Checker extends Transform {
   ...
   * @returns {Observable.<object>} An object providing details about the dependencies.
   */
   ...
   * @param {object} manifest The manifest providing the dependencies.
   * @returns {Observable.<object>} An object providing details about the dependencies that are outdated.
   */
   ...
   * @returns {object} A manifest providing a list of dependencies.
   ...
   * @returns {Observable.<object>} An object providing details about the project dependencies.
   * @private
   */
  _getDependencies(getter, manifest) {
    ...
    return Promise.all(observables).map(deps => ({
      dependencies: deps[0],
